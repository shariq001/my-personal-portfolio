...
const page = () => {
  return (
    <div className='flex md1:flex-row sm1:flex-col sm1:gap-[20px] justify-between items-center sm1:px-[16px] sm2:px-[20px] md1:px-[25px] md2:px-[30px] lg1:px-[50px] lg2:px-[75px] xl:px-[100px] py-[30px] max-w-[1600px] mx-auto'>
      ...
      <div className='flex flex-col gap-[15px] xl:w-[510px]'>
        ...
        <Link href='/Home' className='xl:text-[24px] sm1:text-[14px] font-semibold border-[2px] rounded-[7px] border-white xl:px-[32px] py-[5px] text-center xl:w-[150px] sm1:w-[80px] hover:bg-white hover:text-black duration-700 hover:duration-700'>HOME</Link>
      </div>
