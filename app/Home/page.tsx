    ...
    <div className='sm1:px-[16px] sm2:px-[20px] md1:px-[25px] md2:px-[30px] lg1:px-[50px] lg2:px-[75px] xl:px-[100px] scroll-smooth'>
      ...
      <div className='xl:py-[100px] sm1:py-[50px] my-[20px] flex  flex-col gap-[50px] justify-center items-center bg-gradient-to-tr from-[#1f1f1f] via-[#1f1f1f] to-[#ffffff]/18 rounded-[20px] '>
        ...
        <TypeAnimation
          ...
          repeat={Infinity}
          className={`${syne.className} xl:text-[60px] sm1:text-[25px] md2:text-[32px] md2:w-[550px] lg2:text-[40px] lg2:w-[600px] font-medium text-center leading-[95%] xl:w-[900px]`}
        />
      ...
      <div className='flex flex-col justify-center items-center py-[50px]'>
        ...
        <div className='py-[50px] bg-gradient-to-tl from-[#1f1f1f] via-[#1f1f1f] to-[#ffffff]/18 rounded-[20px] w-full my-[50px] px-[20px]'>
          ...
          <div className='w-full flex justify-between items-center '>
            ...
            <Image src='/quotes.png' width={200} height={180} alt='Quotes' className='sm1:hidden md2:block xl:w-[200px] xl:h-[180px] md2:w-[100px] lg1:w-[150px] lg2:w-[180px]'/>
          </div>
